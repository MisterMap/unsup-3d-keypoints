...
class TestSevenScenesDataModule(unittest.TestCase):
    ...
    def test_load(self):
        self.assertEqual(len(self._data_module._train_dataset), 4458)
        self.assertEqual(len(self._data_module._test_dataset), 4458)
        ...
        for batch in batches:
            ...
            self.assertEqual(batch["mask"].shape, torch.Size([64]))
